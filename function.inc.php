...
function couponEmail($id = '')
{
  ...
  if ($arr[0]['coupon_type'] == 'F') {
    $html .= "<div class='cell'>" . $arr[0]['coupon_code'] . "</div>
          <div class='cell'>₹" . $arr[0]['coupon_value'] . "</div>
  ...
  $html .= ' 
    ...
    <p>If you have any questions about this coupon code, simply reply to this email or reach out to our <a href="' . FRONT_SITE_PATH . '" target="_blank" style="text-decoration: none; color: blue;">support team</a> for help.</p>
                          <p>Cheers,
                            <br>' . FRONT_SITE_NAME . '</p>
  </div>
